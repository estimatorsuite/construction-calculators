...
const JOB_TYPE_ICONS: Record<ElectricalJobType, React.ElementType> = {
  "panel-upgrade": Zap,
  "outlet-install": Plug,
...
const JOB_TYPES: ElectricalJobType[] = [
  "panel-upgrade",
  "outlet-install",
  "light-fixture",
  "ev-charger",
...
export function ElectricalEstimateCalculator() {
  ...
  function handleJobTypeChange(job: ElectricalJobType) {
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              updateState({
                laborRatePerHour: Math.max(40, Number(e.target.value) || 90),
              })
            }
            className="w-full rounded-lg border border-border bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-accent/50"
            min={40}
      ...
      <div className="text-xs text-muted-foreground bg-muted/30 rounded-lg p-3">
        <div className="flex items-start gap-2">
          ...
          <p>
            ...
            panel accessibility, and local labor rates. Whole-house rewiring,
            trenching for underground service, and service entrance upgrades
            add significant cost not captured here. Always verify with a
