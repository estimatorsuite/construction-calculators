import { getMaterialCalculators } from "@/lib/calculators-meta";

export default function CalculatorsIndexPage() {
  const calculators = getMaterialCalculators();
  ...
  return (
    <div className="container mx-auto max-w-5xl px-4 py-8">
      ...
      <p className="text-muted-foreground mb-8">
        {calculators.length} free construction material calculators. Concrete, roofing, flooring, siding, and more.
      </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {calculators.map((calc) => (
          <a
            key={calc.slug}
            href={`/construction-calculators/calculators/${calc.slug}/`}
